...
DATASET_PROFILES = {
    ...
    "sn": {
        "data_module": "util.SN.data_SN",
        "process_mode": "dict",
        "description": "Eadro SN microservice benchmark",
        "random_seed": 42,
        "gpu": True,
        "epochs": 80,
        "patience": 10,
        ...
        "persistent_workers": False,
        "max_timesteps": 0,
        "data_path": "./data/SN-pre",
        "dataset_path": "./data/SN-save",
        "result_dir": "./result",
        "main_model": "Ada-MGAD",
        "evaluate": False,
        "model_path": None,
    ...
    "tt": {
        "data_module": "util.TT.data_TT",
        "process_mode": "dict",
        "description": "Eadro TT microservice benchmark",
        "random_seed": 42,
        "gpu": True,
        "epochs": 50,
        "patience": 8,
        ...
        "persistent_workers": False,
        "max_timesteps": 0,
        "data_path": "./data/TT-pre",
        "dataset_path": "./data/TT-save",
        "result_dir": "./result",
        "main_model": "Ada-MGAD",
        "evaluate": False,
        "model_path": None,
    ...
    "nezha": {
        "data_module": "util.Nezha.data_Nezha",
        "process_mode": "dict",
        "description": "Nezha OnlineBoutique microservice benchmark",
        "random_seed": 42,
        "gpu": True,
        "epochs": 60,
        "patience": 10,
        ...
        "persistent_workers": False,
        "max_timesteps": 0,
        "data_path": "./data/Nezha-pre",
        "dataset_path": "./data/Nezha-save",
        "result_dir": "./result",
        "main_model": "Ada-MGAD",
        "evaluate": False,
        "model_path": None,
...
ARG_SPECS = [
    ...
    ("test_experiment", int, "SN/Nezha/TT: index of the held-out fault experiment or day (supports negative indexing)."),
]
