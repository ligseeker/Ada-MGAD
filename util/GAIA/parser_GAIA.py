...
parser = argparse.ArgumentParser(description='Ada-MGAD on GAIA Dataset')
...
parser.add_argument("--learning_change", default=30, type=int,
                    help='the epoch number that change learning rate')
parser.add_argument("--learning_gamma", default=0.5, type=float,
...
parser.add_argument("--main_model", default='Ada-MGAD', type=str,
